...
namespace TaskManager {
	...
	private: System::Windows::Forms::ToolStripMenuItem^  íîâàÿÇàäà÷àToolStripMenuItem;

	private: System::Windows::Forms::ToolStripMenuItem^  ñâîäêàToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->íîâàÿÇàäà÷àToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->ñâîäêàToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {this->ôàéëToolStripMenuItem, 
				this->äåéñòâèåToolStripMenuItem, this->ñâîäêàToolStripMenuItem});
			...
			// 
			this->ôàéëToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {this->toolStripMenuItem1, 
			...
			// 
			this->äåéñòâèåToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) {this->íîâàÿÇàäà÷àToolStripMenuItem});
			...
			// 
			// íîâàÿÇàäà÷àToolStripMenuItem
			// 
			this->íîâàÿÇàäà÷àToolStripMenuItem->Name = L"íîâàÿÇàäà÷àToolStripMenuItem";
			this->íîâàÿÇàäà÷àToolStripMenuItem->Size = System::Drawing::Size(152, 22);
			this->íîâàÿÇàäà÷àToolStripMenuItem->Text = L"Íîâàÿ çàäà÷à";
			this->íîâàÿÇàäà÷àToolStripMenuItem->Click += gcnew System::EventHandler(this, &MainForm::íîâàÿÇàäà÷àToolStripMenuItem_Click);
			// 
			// ñâîäêàToolStripMenuItem
			// 
			this->ñâîäêàToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) {this->ïğîÀâòîğàToolStripMenuItem});
			this->ñâîäêàToolStripMenuItem->Name = L"ñâîäêàToolStripMenuItem";
			this->ñâîäêàToolStripMenuItem->Size = System::Drawing::Size(58, 20);
			this->ñâîäêàToolStripMenuItem->Text = L"Ñâîäêà";
			// 
			// ïğîÀâòîğàToolStripMenuItem
			// 
			this->ïğîÀâòîğàToolStripMenuItem->Name = L"ïğîÀâòîğàToolStripMenuItem";
			this->ïğîÀâòîğàToolStripMenuItem->Size = System::Drawing::Size(137, 22);
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(5) {this->Name, this->ID, 
			...
			// ID
			// 
			this->ID->HeaderText = L"ID ïğîöåññà";
			this->ID->Name = L"ID";
			this->ID->ReadOnly = true;
			// 
			// Memory
			// 
			this->Memory->HeaderText = L"Ïàìÿòü";
			this->Memory->Name = L"Memory";
			this->Memory->ReadOnly = true;
			// 
			// Threads
			// 
			this->Threads->HeaderText = L"Êîëè÷åñòâî ïîòîêîâ";
			...
			this->button1->Text = L"Çàâåğøèòü ïğîöåññ";
			...
			this->button2->Text = L"Îíîâèòü ñïèñîê";
			...
			this->tabPage1->Text = L"Òàáëèöà ïğîöåññîâ";
			...
			this->tabPage2->Text = L"Ãğàôèê ÖÏ";
			...
			series1->Name = L"Íàãğóæåííîñòü ÖÏ";
			...
			this->tabPage3->Text = L"Ãğàôèê ïàìÿòè";
			...
			series2->Name = L"Èñïîëüçîâàíèå ïàìÿòè";
...
#pragma endregion
	...
	void GetRAMUsage()
	{
		...
		RAMUsage = (floor((double)physMemUsed / (1024 * 1024 * 1024) * 10) / 10);
		RAMTotal = (floor((double)totalPhysMem / (1024 * 1024 * 1024) * 10) / 10);
	}
	...
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e)
	{
		...
		label1->Text = "Ïàìÿòü : " + RAMUsage + " / " + RAMTotal + " ÃÁ";
	...
	private: System::Void íîâàÿÇàäà÷àToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
	{
		NewProcess();
	}
	...
	{
		System::Windows::Forms::MessageBox::Show("Äóáèöêèé Àíòîí, ñòóäåíò ãğóïïû 830501", "Ïğî àâòîğà");
	}
	...
	private: System::Void ñíÿòüÇàäà÷óToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
	{
		KillProcess(dataGridView1->CurrentRow->Index);
	}
};
